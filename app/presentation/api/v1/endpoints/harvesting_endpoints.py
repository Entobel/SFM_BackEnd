...
async def create_harvesting_report(
    ...
    harvesting_dto = HarvestingDTO(
        ...
        growing=GrowingDTO(id=body.growing_id),
...
async def get_list_harvesting_report(
    ...
    list_harvesting_response = [
        HarvestingResponseSchema(
            id=hzl.harvesting.id,
            date_produced=hzl.harvesting.date_produced,
            shift=ShiftResponseSchema(
                id=hzl.harvesting.shift.id,
                name=hzl.harvesting.shift.name,
            ),
            factory=FactoryResponseSchema(
                id=hzl.harvesting.factory.id,
                name=hzl.harvesting.factory.name,
                abbr_name=hzl.harvesting.factory.abbr_name,
            ),
            assigned_zone_levels=harvesting_zone_level_map.get(
                hzl.harvesting.id, []),
            substrate_moisture=hzl.harvesting.substrate_moisture,
            number_crates=hzl.harvesting.number_crates,
            notes=hzl.harvesting.notes,
            is_active=hzl.harvesting.is_active,
            status=hzl.harvesting.status,
            created_by=UserResponseSchema(
                id=hzl.created_by.id,
                first_name=hzl.created_by.first_name,
                last_name=hzl.created_by.last_name,
                email=hzl.created_by.email,
                phone=hzl.created_by.phone,
            ),
            rejected_by=UserResponseSchema(
                id=hzl.rejected_by.id,
                first_name=hzl.rejected_by.first_name,
                last_name=hzl.rejected_by.last_name,
                email=hzl.rejected_by.email,
                phone=hzl.rejected_by.phone,
            ),
            rejected_at=hzl.rejected_at,
            rejected_reason=hzl.rejected_reason,
            approved_by=UserResponseSchema(
                id=hzl.approved_by.id,
                first_name=hzl.approved_by.first_name,
                last_name=hzl.approved_by.last_name,
