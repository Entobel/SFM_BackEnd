...
from app.domain.interfaces.services.access_policy_service import IAccessPolicyService
...
from app.infrastructure.database.repositories.common_repository_impl import (
    CommonRepository,
)
...
def get_common_repository(db: DatabaseDep) -> ICommonRepository:
    return CommonRepository(conn=db)


CommonRepositoryDep = Annotated[ICommonRepository, Depends(get_common_repository)]
